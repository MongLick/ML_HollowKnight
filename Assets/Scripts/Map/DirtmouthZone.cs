...
public class DirtmouthZone : MonoBehaviour
{
	...
	private IEnumerator FadeIn()
	{
		...
		while (elapsedTime < fadeDuration)
		{
			...
			DirtmouthCanvas.alpha = Mathf.Clamp01(elapsedTime / fadeDuration);
			yield return null;
		}
		DirtmouthCanvas.alpha = 1f;
	...
	private IEnumerator FadeOut()
	{
		...
		{
			elapsedTime += Time.deltaTime;
			DirtmouthCanvas.alpha = Mathf.Clamp01(1f - (elapsedTime / fadeDuration));
			yield return null;
		}
		DirtmouthCanvas.alpha = 0f;
	}
}
